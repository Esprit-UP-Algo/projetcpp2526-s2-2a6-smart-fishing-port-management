...
// Correction : le namespace s'appelle QtCharts (avec C majuscule)
// La ligne using namespace n'est pas nécessaire, on la supprime.
...
void MainWindow::onShowAnalytics()
{
    ...
    // Ces trois lignes n'étaient pas utilisées et provoquaient des erreurs si les membres n'existent pas.
    // On les commente ou on les supprime.
...
void MainWindow::generateAnalyticsPDF()
{
    ...
    // Correction : utiliser QPageSize::A4
