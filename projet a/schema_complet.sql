...
-- EMPLOYES
INSERT INTO EMPLOYEE (ID,NOM,POSTE,EMAIL,PASSWORD,TELEPHONE,SALAIRE)
VALUES (SEQ_EMPLOYEE.NEXTVAL,'Ahmed Ben Ali','Capitaine de port','ahmed@port.tn','ahmed123','+216 20 123 456',3500.00);

INSERT INTO EMPLOYEE (ID,NOM,POSTE,EMAIL,PASSWORD,TELEPHONE,SALAIRE)
VALUES (SEQ_EMPLOYEE.NEXTVAL,'Fatma Trabelsi','Agent maritime','fatma@port.tn','fatma123','+216 22 234 567',2800.00);

INSERT INTO EMPLOYEE (ID,NOM,POSTE,EMAIL,PASSWORD,TELEPHONE,SALAIRE)
VALUES (SEQ_EMPLOYEE.NEXTVAL,'Mohamed Gharbi','Technicien','gharbi@port.tn','gharbi123','+216 24 345 678',2200.00);
