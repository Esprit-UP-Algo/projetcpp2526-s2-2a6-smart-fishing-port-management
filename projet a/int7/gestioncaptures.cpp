...
void GestionCaptures::configurerFormulaire()
{
    ...
    formFrame->setStyleSheet("background-color: white; border-radius: 8px; border: 1px solid #e2e8f0; padding: 20px;");
    ...
    editShipName->setMinimumHeight(35);
    ...
    editFishIcon->setMaximumWidth(60);
    ...
    textComments->setMaximumHeight(80);
    ...
    btnSave->setStyleSheet("background-color: #3b82f6; color: white; font-weight: bold; font-size: 14px; padding: 6px; border-radius: 6px;");
