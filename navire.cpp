    ...
    , m_trayIcon(new QSystemTrayIcon(this))
{
    ...
    // Création de la table principale si elle n'existe pas (ignore l'erreur ORA-00955: un objet de ce nom existe déjà)
    QSqlQuery qInit(m_connection.getDb());
    qInit.exec("CREATE TABLE navire ("
